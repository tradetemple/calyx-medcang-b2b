  ...
  return (
    <div className="min-h-screen bg-black text-green-500 font-mono p-4 md:p-8 flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-4xl mb-8">
        ...
        {/* Error Header */}
        <div className="bg-black border-2 border-red-500/50 rounded-lg p-6 shadow-2xl shadow-red-900/20">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-8 h-8 bg-red-500/20 rounded flex items-center justify-center border border-red-500">
              <svg 
            ...
            <div>
              <h1 className="text-2xl font-bold text-red-500 tracking-wider uppercase">
          ...
          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <span className="text-yellow-500 font-bold min-w-[100px]">{t.details.activePolicy}</span>
              <code className="text-green-400 bg-green-900/20 px-2 py-1 rounded border border-green-500/30 text-sm">
          ...
          <div className="mt-6 bg-gray-900/50 rounded-lg p-4 border border-gray-700">
            ...
            <pre className="text-xs md:text-sm text-blue-300 overflow-x-auto">
          ...
          {/* Solution Section */}
          <div className="mt-6 bg-green-900/10 rounded-lg p-4 border border-green-500/30">
