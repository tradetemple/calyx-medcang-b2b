...
export default async function Home({ params }: { params: Promise<{ lang: string }> }) {
  ...
  return (
    <div className="bg-bg-main text-static-black selection:bg-accent selection:text-white">
      ...
      {/* 1. HERO SECTION */}
      <div className="relative h-[70vh] md:h-[92vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 mt-8 gap-4 md:gap-6 w-full">
            ...
            >  
              <div className='flex items-center p-6 sm:p-8 h-full'>
                <div className='p-4 bg-slate-50 text-primary rounded-xl group-hover:scale-105 transition-transform duration-300 shadow-sm'>
                ...
                <div className='flex flex-col items-start pl-6 border-l border-slate-200 ml-6'>
                  <h3 className='font-bold text-slate-800 tracking-tight text-xl mb-1 group-hover:text-primary transition-colors'>{t.hero.cta}</h3>
                  <span className='font-normal text-left text-sm text-slate-500 leading-relaxed max-w-xl'>
                    {t.hero.ctaSubtitle}
                  </span>
                </div>
              </div>
            ...
            >  
              <div className='flex items-center p-6 h-full'>
                ...
                <div className='flex flex-col items-start'>
                  <h3 className='font-bold text-slate-800 tracking-tight text-lg group-hover:text-emerald-600 transition-colors'>{t.hero.cta1}</h3>
                  <span className='text-sm text-slate-500 mt-1 text-left'>
                    {t.hero.cta1Subtitle}
                  </span>
                </div>
              </div>
            ...
            >  
              <div className='flex items-center p-6 h-full'>
                ...
                <div className='flex flex-col items-start'>
                  <h3 className='font-bold text-slate-800 tracking-tight text-lg group-hover:text-blue-600 transition-colors'>{t.hero.cta2}</h3>
                  <span className='text-sm text-slate-500 mt-1 text-left'>
                    {t.hero.cta2Subtitle}
                  </span>
                </div>
